...
if(in_array($chat_id,$block_list)){
	if($settings['support']!='تنظیم نشده' || file_exists('data/bot/settings.json')==false){
		...
		sendMessage($chat_id,"📛متاسفانه شما از ربات ما بلاک شده اید با آیدی پشتیبانی @Dandeh5_bot در تماس باشید📛",'HTML',null);
	}
	die;
}
#max warning
