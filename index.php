...
$API_KEY = '725175461:AAFrcL2t1kPPa-VTuCcw-hizm05kZE7hhQk';
...
📊 افزایش بازدید کانالها و چالشها
👥 زیر مجموعه گیری با ۲۰ درصد پورسانت
✅ قابلیت معامله ی سکه ها با شارژ و پول
...
'reply_to_message_id'=>$message_id,
            'reply_markup' => json_encode([
                'inline_keyboard' => [
                      [['text' => "50 بازدید | 50 سکــ💰ـــه", 'callback_data' => "seen50"]],
                    [['text' => "100 بازدید | 100 سکــ💰ـــه", 'callback_data' => "seen100"]],
                    [['text' => "250 بازدید | 250 سکــ💰ـــه", 'callback_data' => "seen250"]],
                    [['text' => "500 بازدید | 500 سکــ💰ـــه", 'callback_data' => "seen500"]],
                    [['text' => "1000 بازدید | 1000 سکــ💰ــه", 'callback_data' => "seen1000"]],
        ...
        bot('sendMessage', [
            ...
            'text' => "👉👉🤝👁‍🗨".($al)."👁‍🗨🤝👈👈",
                ...
                'reply_markup' => json_encode([
                    'inline_keyboard' =>  [
                        [
                           ['text' => "ثبت بازدید 👁‍🗨",  'callback_data' => "ok"], ['text' => "گزارش تخلف🚫",  'callback_data' => "goza"]
                        ],
			[
			   ['text' => "شتـــ💫ــاب", 'callback_data' => "shetab"]
			],
			[
			   ['text' => "ѕσℓαя | ســــــ🌓ـــــولار", 'url' => "https://t.me/$botids"]
			]	
                    ]
                ])
            ]);
