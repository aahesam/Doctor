...
شما برای ارسال پست خودتون داخل کانال جهت ویو خوردن باید رعد خرج کنید ، اینگونه است که هر 1⃣ سکه براره با 1⃣ بازدید☺️
...
| دکمه وسط 👁‍🗨 | برای ثبت بازدید و گرفتنِ رعد هست ، شما وقتی یک بنر را میبینید حتما باید روی این گزینه کلیک کنید تا بازدیدتون ثبت بشه و یک سکه به سکه های که دارید اضافه بشه🙂
...
'reply_markup'=>json_encode([
	...
	[
              ['text'=>"کد ساخته شده در ساعت: ", 'url'=>"https://t.me/solar_viewbot "],['text'=>"$time", 'url'=>"https://t.me/RadViewBot "]
    ],
	[
              ['text'=>"و در تاریخ: ", 'url'=>"https://t.me/solar_viewbot "],['text'=>"$date", 'url'=>"https://t.me/RadViewBot "]
    ],
	[
              ['text'=>"$kodomadmin", 'url'=>"https://t.me/solar_viewbot "],['text'=>"توسط: ", 'url'=>"https://t.me/RadViewBot "]
    ],
	[
