            ...
            'chat_id' => $chat_id,
                ...
                'reply_markup' => json_encode([
                    'keyboard' => [
						...
						[['text' => "⚡️ دریافت رعد رایگان ⚡️"]],
						[['text' => "🛒فروشگاه"], ['text' => "⚖️ قوانین و مقررات"], ['text' => "🗓پیگیری سفارشات"]],
                    [['text' => "☎️ارتباط با پشتیبانی"], ['text' => "🎁کد هدیه"], ['text' => "📊گزارشات رعد"]],
                    [['text' => "👑رتبه بندی"]],
...
file_put_contents("data/$chat_id/shoklat.txt",$shoklat + $rand);
            ...
            'chat_id' => $chat_id,
                'text' => "✅ تبریک!
👈 $rand رعد هدیه روزانه از بسته شماره $text به حسابتان افزوده شد ☺️",
                'parse_mode' => "MarkDown",
                'reply_markup' => json_encode([
                    'keyboard' => [
                        [['text' => "بازگشت"],],
...
file_put_contents("ads/code/$text.txt", "true");
        bot('sendmessage', [
            'chat_id' => $chat_id,
            'text' => "تبریک کدت درست بود و تعداد $shocode رعد بهت اضافه شد.",
            'parse_mode' => "MarkDown",
        ]);
        bot('sendmessage', [
            'chat_id' => $channel2,
...
برای انجام عملیات مورد نظر، لطفا از دکمه های پایین استفاده نمایید.",
 ...
 if ($text == "⚡️ دریافت رعد رایگان ⚡️") {
        ...
        bot('sendmessage', [
            ...
            'reply_markup' => json_encode([
                'keyboard' => [
                   [['text' => "⚡️رعد روزانه"],['text' => "👁‍🗨دیدن تبلیغات درون کانال"]],
				   [['text' => "بازگشت"]],
                ]
            ])
        ]);
 ...
 'reply_to_message_id'=>$message_id,
            'reply_markup' => json_encode([
                'inline_keyboard' => [
                    [
                        ['text' => "250 رعد | 1000 تومن", 'callback_data' => "idposht"]
                ],
                    [
                        ['text' => "500 رعد | 2000 تومن", 'callback_data' => "idposht"]
                ],
                    [
                        ['text' => "750 رعد | 3000 تومن", 'callback_data' => "idposht"]
                ],
                    [
                        ['text' => "1500 رعد | 5000 تومن", 'callback_data' => "idposht"]
                ],
                ]
            ])
        ]);
 ...
 if($text == "👁‍🗨دیدن تبلیغات درون کانال") {
        bot('sendmessage', [
            'chat_id' => $chat_id,
            'text' => "به بخش ⚡️دریافت رعد⚡️خوش آمدید.

🎁 رعدویو دارای ۳ پنل به همراه ضرایب زیر می باشد.
...
برای انجام عملیات مورد نظر، لطفا از دکمه های پایین استفاده نمایید.",
	...
	$setkharid = file_get_contents("data/setkharid.txt");
        ...
        bot('sendmessage', [
            'chat_id' => $chatid,
            'message_id' => $message_id2,
            'text' => "💳جهت خرید نهایی تعداد رعد را به ایدی زیر اعلام کنید:
...
شما برای ارسال پست خودتون داخل کانال جهت ویو خوردن باید رعد خرج کنید ، اینگونه است که هر 1⃣ رعد براره با 1⃣ بازدید☺️
پس فهمیدید که کسانی که پست های کانال رو ویو میزنن بیکار تشریف ندارن و صرفا دارن رعد جمع میکنن !
 
شما وارد کاناله . $channel.  میشید ؛ با بازدید ثبت کردن ( روی دکمه های ثبت بازدید داخل کانال کلیک کنید تا بازدیدی که از بنر کردی ثبت بشه ) رعد جمع میکنید
...
| دکمه وسط 👁‍🗨 | برای ثبت بازدید و گرفتنِ رعد هست ، شما وقتی یک بنر را میبینید حتما باید روی این گزینه کلیک کنید تا بازدیدتون ثبت بشه و یک رعد به رعد های که دارید اضافه بشه🙂
...
شما به طور معمول ، هر 100 بازدیدی که در کانال ثبت کنید 80 رعد در قبالش دریافت خواهید کرد یعنی با ضریبه 0.8 و پنل شما برنزی هست !

-سه پنله مختلف با ضریب های مختلف وجود داره :
🥉: پنل برنزی / هر 100 بازدید 80 رعد / ضریبه  0.8
🥈 : پنل نقره ای / هر 100 بازدید 100 رعد / ضریبه 1
🥇 : پنل طلای / هر 100 بازدید 140 رعد / ضریبه 1.4

- برای اینکه ارتقا پیدا کنید به پنل های دیگر لطفا به دکمه ' زیر مجموعه گیری ' بروید ، متوجه میشوید

- بعد از رعد جمع کردن وارد دکمه ثبت تبلیغ در ربات بشید و تبلیغتون رو ثبت کنید

برخی دیگر از امکانات ربات:

| انتقال و دریافت رعد بین دوستان خود داخل ربات
| فروش رعد های خود به هر قیمتی که دوست دارید !
| رعد بدهید بجایش شارژ دریافت کنید !
...
🚀 تعداد: $kandom33
-  -  -  -  -
- چالش #نصفه یادتون نره بیایید تو پشتیبانی بگید بنر بده ! بنر میدیم هرچقدر بازدید زدید نصفه بازدیدی که زدی رعد تحیول میدیم بهت ! ⚡️💦",
 				'parse_mode'=>'MarkDown',
        ]);
		}
		if ($data == "topzi") {
...
موفق باشید🤷‍♂️",
        ...
        'photo'=>"http://uupload.ir/files/ds15_photo_2018-09-02_08-29-07.jpg",
        'caption'=>"رعدویو ، یک روش جدید! 👁‍🗨

📊 افزایش بازدید کانالها و چالشها
👥 زیر مجموعه گیری با ۲۰ درصد پورسانت
✅رعد روزانه و کد رایگان و شتاب و انتقال رعد
✅رعد کم=بیشترین بازدید
👇!تا خز نشدع استارت کن رباتو",
'reply_to_message_id'=>$message_id,
'reply_markup' => json_encode([
                'inline_keyboard' => [
                [
...
http://telegram.me/$botids?start=$chatid",
	...
	bot('sendmessage', [
            'chat_id' => $chatid,
            'text' => "اول اینکه بدونین هرکس با لینکه شما وارد ربات بشه $setzirm رعد هدیه دریافت میکنید !

و وقتی هم هر یک از زر مجموعه های شما ثبت تبلیغ کنند 20 درصد از رعدش میاد برای شما !!

حالا از اون باحال تر این که هر یک از زیر مجموعه های شما که برای اولین بار ثبت بازدید کنند 25 رعد به شما واریز میشه !!! 😳😐👌
...
- با دکمه انتقال رعد میتوانی رعد های که دارید رو انتقال بدید به دیگران .
- با دکمه تاریخچه دریافتی ها میتوانید کلیه مشخصات دریافتی رعد های خودتون رو ببینید . 
- با دکمه تاریخچه انتقال ها میتونید کلیه مشخصات انتقال رعد های خودتون رو مشاهده کنید .
...
'reply_to_message_id'=>$message_id,
       'reply_markup' => json_encode([
                'keyboard' => [
                    [
                        ['text' => "📈 تاریخچه انتقال 📈"], ['text' => "📉 تاریخچه دریافت 📉"], ['text' => "⚡️ انتقال رعد 💸"]
                ],
[
                        ['text' => "بازگشت"]
                ],
...
👁‍🗨بازدید فعلی شما: $sho");
        ...
        bot('sendmessage', [
            'chat_id' => $chat_id,
            'text' => "❓ مقدار بازدیدی که مایلید تبلیغات شما به کاربران رعدویو نشان داده شود را انتخاب کنید.",
'reply_to_message_id'=>$message_id,
            'reply_markup' => json_encode([
                'inline_keyboard' => [
                      [['text' => "50 بازدید | 50 رعــ⚡️ـــد", 'callback_data' => "seen50"]],
                    [['text' => "100 بازدید | 100 رعــ⚡️ـــد", 'callback_data' => "seen100"]],
                    [['text' => "250 بازدید | 250 رعــ⚡️ـــد", 'callback_data' => "seen250"]],
                    [['text' => "500 بازدید | 500 رعــ⚡️ـــد", 'callback_data' => "seen500"]],
                    [['text' => "1000 بازدید | 1000 رعــ⚡️ـــد", 'callback_data' => "seen1000"]],
                    [['text' => "بازدید دلخواه⚡️", 'callback_data' => "dekkhah"]],
        ...
        bot('answercallbackquery', [
            'callback_query_id' => $update->callback_query->id,
            'text' => "‼️با عرض معذرت تعداد رعد های شما کم میباشد😔",
            'show_alert' => true
        ]);
        }
    } elseif ($data == "seen100") {
...
⚖️پستتون اگر بر خلاف قوانین بود به طور خودکار حذف میشه و رعدتون برگشته نمیشود(برای فهمیدن قوانین،به صفحه اول بروید و دکمه قوانین را بزنید)
...
⚠️توجه در صورتی که از ثبت تبلیغ منصرف شدید روی دکمه زیر کلیک کنید",
        ...
        bot('sendMessage', [
            ...
            bot('answercallbackquery', [
                'callback_query_id' => $update->callback_query->id,
                'text' => "متاسفم تعداد رعد های شما با تعداد ویو درخواستی برابری نمیکند",
                'show_alert' => true
            ]);
        }
    } elseif ($data == "dekkhah"){
...
⚠️توجه در صورتی که از ثبت تبلیغ منصرف شدید روی دکمه زیر کلیک کنید",
            ...
            bot('sendmessage', [
                'chat_id'=>$chat_id,
                'text' => "آیا میخواهید این تبلیغ را بع تعداد  بازدید ثبت کنید؟🤔
اگه آره روی✅ بزن
اگه نه هم روی ❌ بزن",
'reply_to_message_id'=>$message_id,
            'reply_markup' => json_encode([
        ...
        bot('sendMessage', [
            ...
            'text' => "👈👈👈👁‍🗨".($al)."👁‍🗨👉👉👉",
                ...
                'reply_markup' => json_encode([
                    'inline_keyboard' =>  [
                        [
                           ['text' => "ثبت بازدید👁‍🗨",  'callback_data' => "ok"], ['text' => "بپر تو ربات🤖", 'url' => "https://t.me/$botids"], ['text' => "گزارش تخلف🚫",  'callback_data' => "goza"], ['text' => "شتاب⚡️", 'callback_data' => "shetab"]
                        ],
                    ]
                ])
            ]);
        ...
        bot('sendMessage', [
            ...
            'reply_markup' => json_encode([
                'inline_keyboard' => [
					...
					[
                        ['text' => "تنظیم تعداد رعد به ازای هر بازدید", 'callback_data' => "setbazdid"]
                    ],
					[
                        ['text' => "تنظیم متن استارت", 'callback_data' => "setstart"]
                    ],
					[
                        ['text' => "تنظیم رعد روزانه", 'callback_data' => "setraed"]
                    ],
					[
                        ['text' => "تنظیم تعداد رعد برای آوردن هر زیر مجموعه", 'callback_data' => "setzirm"]
                    ],
					[
...
25",
	...
	elseif ($data == "setraed"){
        ...
        bot('editmessagetext', [
            'chat_id' => $chatid,
            'message_id' => $message_id2,
            'text' => "خب ادمین عزیز لطفا تعداد رعد را به صورت زیر مشخص کنید👇👇

یه پیام برام بفرستید که در خط اول کمترین تعداد رعد روزانه برای هر شخص و در خط دوم بیشترین تعداد رعد برای هر شخص وارد شده باشد.
...
25",
        ...
        bot('sendMessage', [
            'chat_id' => $chat_id,
            'text' => "تبریک تعداد رعد روزانه تنظیم شد.",
        ]);
    }
	elseif ($data == "setzirm"){
        bot('answercallbackquery', [
        ...
        bot('editmessagetext', [
            'chat_id' => $chatid,
            'message_id' => $message_id2,
            'text' => "خب ادمین عزیز لطفا تعداد رعد را وارد کنید.",
        ]);
...
25",
	...
	elseif ($data == "setbazdid"){
        ...
        bot('sendMessage', [
            'chat_id' => $chat_id,
            'text' => "تعداد $text رعد برای هر بازدید ثبت شد.",
            'reply_markup' => json_encode([
                'keyboard' => [
                    [
                        ['text' => "بازگشت"]
            ...
            'reply_markup' => json_encode([
                'inline_keyboard' => [
                   [
                    ...
                    [
                        ['text' => "بازدید اولیه کاربر", 'callback_data' => "matnstart"],['text' => "⚡️رعد همگانی", 'callback_data' => "s2a seke"]
                    ],
                    [
...
file_put_contents("data/$chatid/kodomadmin.txt", "$data_first");
  ...
  file_put_contents("data/$chat_id/ali.txt", "$text");
        bot('sendMessage', [
            'chat_id' => $chat_id,
            'text' => "حالا تعداد رعد برای این کد را تعیین کنید.",
        ]);
    } 	elseif ($saeed == "رعد ها") {
...
file_put_contents("data/$chat_id/saeed.txt","none");
 ...
 bot('sendMessage',[
    'chat_id'=>$channel2,
    'text'=>"کد $text رعد ای است.",
'reply_markup'=>json_encode([
            'inline_keyboard'=>[

			[
              ['text'=>"برای ورود به ربات کلیک کنید", 'url'=>"https://t.me/RadViewBot "]
    ],
	[
              ['text'=>"کد ساخته شده در ساعت: ", 'url'=>"https://t.me/RadViewBot "],['text'=>"$time", 'url'=>"https://t.me/RadViewBot "]
    ],
	[
              ['text'=>"و در تاریخ: ", 'url'=>"https://t.me/RadViewBot "],['text'=>"$date", 'url'=>"https://t.me/RadViewBot "]
    ],
	[
              ['text'=>"$kodomadmin", 'url'=>"https://t.me/RadViewBot "],['text'=>"توسط: ", 'url'=>"https://t.me/RadViewBot "]
    ],
	[
             ['text'=>"⚜کد یکبار مصرف", 'url'=>"https://t.me/RadViewBot "]
    ],
	[
           ['text'=>"➖➖➖➖➖➖➖➖", 'url'=>"https://t.me/RadViewBot "]
    ],
	[
              ['text'=>"Code: ", 'url'=>"https://t.me/RadViewBot "],['text'=>"$ali", 'url'=>"https://t.me/RadViewBot "]
    ],
	[
			['text'=>"➖➖➖➖➖➖➖➖", 'url'=>"https://t.me/RadViewBot "]
    ],
	[
         ['text'=>"❗️روش استفاده::", 'url'=>"https://t.me/RadViewBot "]
    ],
	[
        ['text'=>"۱-وارد ربات @RadViewBot  شوید.", 'url'=>"https://t.me/RadViewBot "]
    ],
	[
        ['text'=>"۲-روی گزینه 🎁کد هدیه بزنید.", 'url'=>"https://t.me/RadViewBot "]
    ],
	[
        ['text'=>"۳-کد رایگان $ali را وارد کنید.", 'url'=>"https://t.me/RadViewBot "]
    ],
	[
        ['text'=>"*******************", 'url'=>"https://t.me/RadViewBot "]
    ],
	[
        ['text'=>"🆑 @RadViewBot", 'url'=>"https://t.me/RadViewBot"]
    ],
	[
        ['text'=>"🤖 @RadViewBot ", 'url'=>"https://t.me/RadViewBot "]
    ],
...
file_put_contents("data/$chatid/saeed.txt", "s2a seke1");
        bot('editmessagetext', [
            'chat_id' => $chatid,
            'message_id' => $message_id2,
            'text' => "⚡️ مقدار رعد مورد نظر رو وارد کنید:",
        ]);
    } elseif ($saeed == 's2a seke1') {
        bot('sendMessage', [
            'chat_id' => $chat_id,
            'text' => "⚡️ مقدار رعد به زودی به همه اضافه میشود.",
            'parse_mode' => "MarkDown"
        ]);
	$all_member = fopen( "users.txt", 'r');
		while( !feof( $all_member)) {
 			$user = fgets( $all_member);
            sendmessage($user, "مقدار $text رعد از طرف مدیریت به شما اضافه شد.");
        ...
        bot('sendMessage', [
            'chat_id' => $chat_id,
            'text' => "⚡️ تعداد $text رعد به همه اعضا اضافه شد.",
            'parse_mode' => "MarkDown"
        ]);
file_put_contents("data/$chat_id/saeed.txt", "");
	}
...
از طرف مدیریت ربات  تعداد $text بازدید از حساب شما کسر شد",
    ...
    elseif ($data == "buy") {
        ...
        bot('sendMessage', [
            'chat_id' => $chat_id,
            'text' => "خوب تعداد رعد ها چقدر باشه",
            'parse_mode' => "MarkDown"
        ]);
    } elseif ($saeed == 'buy2') {
        ...
        bot('sendMessage', [
            'chat_id' => $buy,
            'text' => "‼️ کاربر گرامی
🎉 از طرف مدیریت ربات  تعداد $text رعد به حساب شما واریز شد",
            'reply_markup' => json_encode([
                 'keyboard' => [
                    [
                        ['text' => "بازگشت"]
